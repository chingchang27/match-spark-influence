        ...
        {activeTab === 'influencers' && (
          <div className="grid gap-6">
            {influencers.map((influencer) => (
              <Card key={influencer.id} className="bg-white/10 backdrop-blur-lg border-white/20">
                <CardContent className="p-6">
                  <div className="flex justify-between items-start">
                      ...
                      <div className="flex items-center space-x-4 mb-4">
                        ...
                        <div>
                          ...
                          <div className="flex space-x-2 mt-2">
                            <Badge variant={
                              influencer.profiles.approval_status === 'approved' ? 'default' :
                              influencer.profiles.approval_status === 'pending' ? 'secondary' : 'destructive'
                            }>
                    ...
                    <div className="flex flex-col space-y-2 ml-6">
                      {influencer.profiles.approval_status === 'pending' && (
                        <>
                          <Button
                            onClick={() => updateApprovalStatus(influencer.profiles.id, 'approved')}
                            size="sm"
                          ...
                          <Button
                            onClick={() => updateApprovalStatus(influencer.profiles.id, 'rejected')}
                            size="sm"
                            variant="destructive"
                          >
                      ...
                      {influencer.profiles.approval_status === 'approved' && (
                        <div className="space-y-2">
                          <select
                            value={influencer.tier || ''}
                            onChange={(e) => updateInfluencerTier(influencer.id, e.target.value as any)}
                      ...
                      <Button
                        onClick={() => deleteProfile(influencer.profiles.id)}
                        size="sm"
                        variant="destructive"
                      >
        ...
        {activeTab === 'businesses' && (
          <div className="grid gap-6">
            {businesses.map((business) => (
              <Card key={business.id} className="bg-white/10 backdrop-blur-lg border-white/20">
                <CardContent className="p-6">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <div className="flex items-center space-x-4 mb-4">
                        ...
                        <div>
                          ...
                          <Badge variant={
                            business.profiles.approval_status === 'approved' ? 'default' :
                            business.profiles.approval_status === 'pending' ? 'secondary' : 'destructive'
                          } className="mt-2">
                    ...
                    <div className="flex flex-col space-y-2 ml-6">
                      {business.profiles.approval_status === 'pending' && (
                        <>
                          <Button
                            onClick={() => updateApprovalStatus(business.profiles.id, 'approved')}
                            size="sm"
                            className="bg-green-600 hover:bg-green-700"
                          >
                            <CheckCircle className="w-4 h-4 mr-2" />
                          ...
                          <Button
                            onClick={() => updateApprovalStatus(business.profiles.id, 'rejected')}
                            size="sm"
                            variant="destructive"
                          >
                            <XCircle className="w-4 h-4 mr-2" />
                      ...
                      <Button
                        onClick={() => deleteProfile(business.profiles.id)}
                        size="sm"
                        variant="destructive"
                      >
                        <Trash2 className="w-4 h-4 mr-2" />
